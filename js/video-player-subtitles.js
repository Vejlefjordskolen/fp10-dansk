var subtitles = {
    T_194488_video: {
        ...
        tracks: [
			//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:03:15"), "Kun tekst, der er relevant for opgavebesvarelsen, er tekstet til talesyntese"),	
			T(TTime("00:00:03:15"), TTime("00:00:05:15"), "Hvornår har du sidst været nybegynder?"),
			T(TTime("00:00:23:00"), TTime("00:00:24:20"), "Lær Kinesisk"),
			T(TTime("00:00:28:00"), TTime("00:00:30:00"), "Velkommen til kursus<br />Lokale K1"),
			T(TTime("00:00:36:30"), TTime("00:00:38:00"), "Ny i job")
        ]
    },
